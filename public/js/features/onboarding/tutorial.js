...
const BTUT = [
  ...
  { icon:'group', title:'Agrupar, desagrupar e travar',
    body:'Selecione 2+ objetos e use o botão <strong>Grupo</strong> no painel de camadas. Objetos de um grupo continuam individualmente selecionáveis e editáveis no canvas — clique no cabeçalho do grupo no painel para selecionar todos de uma vez. Use o cadeado em qualquer objeto, grupo ou camada para travá-lo: um item travado não pode ser selecionado, movido, redimensionado, rotacionado, excluído nem ter sua visibilidade alterada.' },
